...
public class PoisonArrow extends Bullet
{
    ...
    public void doHit(GridEntity asteroid){
        ...
        if(isupgraded){
            asteroid.applyeffect(new PowerPercentageEffect(0.75, (int)(getDamage()*40*(getNumTargets()>1?0.75:1.5))));
            asteroid.applyeffect(new SpeedPercentageEffect(0.4, (int)(getDamage()*40*(getNumTargets()>1?0.75:1.5))));
        }
