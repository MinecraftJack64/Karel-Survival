...
public class ZNakedMissile extends Bullet
{
    double vx, vy;
    double tvx, tvy;
    double cdirspeed = 1.8; // how fast it can change speed
    double pspeed = 15; // target speed
    public ZNakedMissile(double rotation, GridObject source)
    {
